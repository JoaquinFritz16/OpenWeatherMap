...
units=input('Ingrese la unidad a usar(C para celsius, F para fahrenheit): ')
if units=='C':
    units='metric'
elif units=='F':
    units='imperial'
...
def display_weather(data):
    ...
    print(f"La ciduad es: {city}")
    print(f"La temperatura es de {temp}")
    print(f"La presion es de {pressure}")
